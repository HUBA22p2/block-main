...
"""КАРТИНКИ СПРАЙТІВ"""
hero_l = "images custom/sprite1.png"
hero_r = "images custom/sprite1_r.png"

enemy_r = "images/cyborg.png"
enemy_l = "images/cyborg_r.png"

coin_img = "images custom/coin.png"
...
def start_pos():
    ...
    en2 = Enemy(300, 320, 50, 50, 3, enemy_r, "left")
    en3 = Enemy(500, 160, 50, 50, 3, enemy_r, "left")
    en4 = Enemy(500, 640, 50, 50, 3, enemy_r, "left")
    ...
    for r in level1:
        for c in r:
            ...
            if c == '/':
                ...
                items.add(r2)
            if c == '°':
                r3 = Settings(x, y, 90, 40, 0, coin_img)
                coins_lst.append(r3)
                items.add(r3)
            if c == 'r':
